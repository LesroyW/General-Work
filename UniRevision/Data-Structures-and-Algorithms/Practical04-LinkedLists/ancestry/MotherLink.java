...
public class MotherLink {
	...
	public MotherLink(Female female) {
		 ...
		 */
           lastInLine = new LinearNode<>(female);
	}
	...
	public void addNextInLine(Female daughter)
	{
		 ...
		 */
        LinearNode<Female> nextLastInLine = new LinearNode<>(daughter);
	...
	{		
		String results = "This mother link has " + size() +" people. \n They are: \n " ; 
		...
		if(this.size() == 0)
		{
			return "This link is empty";
		}
		
		if(this.size() == 1)
		{
			return "This mother link has one person" + "\n She is: \n" + lastInLine.getElement().toString();
		}
